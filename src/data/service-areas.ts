...
export const serviceAreasData: ServiceAreasData = {
  ...
  "Palm Beach": [
    { name: "Atlantis", address: "Atlantis, FL, USA", description: "Roofweiler's expert roofing contractors deliver Atlantis high-quality re-roofing and impact windows.", mapUrl: getMapUrl("Atlantis, FL, USA") },
    { name: "Boynton Beach", address: "Boynton Beach, FL, USA", description: "Roofweiler's roofing and impact windows solutions provide Boynton Beach comprehensive hurricane protection.", mapUrl: getMapUrl("Boynton Beach, FL, USA") },
    { name: "Delray Beach", address: "Delray Beach, FL, USA", description: "Roofweiler brings Delray Beach homeowners reliable roofing and impact windows for premium hurricane safety.", mapUrl: getMapUrl("Delray Beach, FL, USA") },
    { name: "Greenacres", address: "Greenacres, FL, USA", description: "Greenacres residents count on Roofweiler's roofing and impact windows for exceptional hurricane protection.", mapUrl: getMapUrl("Greenacres, FL, USA") },
    { name: "Highland Beach", address: "Highland Beach, FL, USA", description: "Upgrade your Highland Beach home with Roofweiler's roofing and impact windows, offering reliable hurricane safety.", mapUrl: getMapUrl("Highland Beach, FL, USA") },
    { name: "Jupiter", address: "Jupiter, FL, USA", description: "Roofweiler delivers Jupiter expert roofing and impact windows with a client-first focus.", mapUrl: getMapUrl("Jupiter, FL, USA") },
    { name: "Lake Park", address: "Lake Park, FL, USA", description: "Roofweiler's expert roofing contractors bring Lake Park premium roofing and impact windows.", mapUrl: getMapUrl("Lake Park, FL, USA") },
    { name: "Loxahatchee Groves", address: "Loxahatchee Groves, FL, USA", description: "Roofweiler's roofing and impact windows ensure Loxahatchee homeowners have reliable hurricane safety.", mapUrl: getMapUrl("Loxahatchee Groves, FL, USA") },
    { name: "North Palm Beach", address: "North Palm Beach, FL, USA", description: "Roofweiler: North Palm Beach leading roofing and impact windows company, providing client-first hurricane protection.", mapUrl: getMapUrl("North Palm Beach, FL, USA") },
    { name: "Palm Beach Gardens", address: "Palm Beach Gardens, FL, USA", description: "Roofweiler: Palm Beach Gardens' trusted roofing company for roofing and impact windows with client-first focus.", mapUrl: getMapUrl("Palm Beach Gardens, FL, USA") },
    { name: "Riviera Beach", address: "Riviera Beach, FL, USA", description: "Roofweiler brings Riviera Beach homeowners quality roofing and impact windows with comprehensive hurricane protection.", mapUrl: getMapUrl("Riviera Beach, FL, USA") },
    { name: "South Palm Beach", address: "South Palm Beach, FL, USA", description: "Roofing and impact windows tailored for South Palm Beach, Roofweiler brings hurricane protection with a friendly touch.", mapUrl: getMapUrl("South Palm Beach, FL, USA") },
    { name: "West Palm Beach", address: "West Palm Beach, FL, USA", description: "Roofweiler's roofing and impact windows provide West Palm Beach homeowners with comprehensive hurricane protection.", mapUrl: getMapUrl("West Palm Beach, FL, USA") },
    { name: "Belle Glade", address: "Belle Glade, FL, USA", description: "Roofweiler offers Belle Glade top-rated roofing and impact windows with excellent customer service.", mapUrl: getMapUrl("Belle Glade, FL, USA") },
    { name: "Briny Breezes", address: "Briny Breezes, FL, USA", description: "Briny Breezes relies on Roofweiler's roofing and impact windows for exceptional hurricane protection.", mapUrl: getMapUrl("Briny Breezes, FL, USA") },
    { name: "Glen Ridge", address: "Glen Ridge, FL, USA", description: "Roofweiler's expert roofing contractors bring Glen Ridge high-quality roofing and impact windows.", mapUrl: getMapUrl("Glen Ridge, FL, USA") },
    { name: "Gulf Stream", address: "Gulf Stream, FL, USA", description: "Roofweiler's roofing and impact windows keep Gulf Stream homes safe and hurricane-ready.", mapUrl: getMapUrl("Gulf Stream, FL, USA") },
    { name: "Hypoluxo", address: "Hypoluxo, FL, USA", description: "Roofweiler's roofing and impact windows provide Hypoluxo homeowners with comprehensive hurricane protection.", mapUrl: getMapUrl("Hypoluxo, FL, USA") },
    { name: "Jupiter Inlet Colony", address: "Jupiter Inlet Colony, FL, USA", description: "Roofweiler's roofing and impact windows solutions provide Jupiter Inlet Colony homeowners with comprehensive hurricane safety.", mapUrl: getMapUrl("Jupiter Inlet Colony, FL, USA") },
    { name: "Lake Worth Beach", address: "Lake Worth Beach, FL, USA", description: "Roofweiler delivers Lake Worth Beach reliable roofing and impact windows with friendly customer service.", mapUrl: getMapUrl("Lake Worth Beach, FL, USA") },
    { name: "Manalapan", address: "Manalapan, FL, USA", description: "Roofweiler offers Manalapan premium roofing and impact windows, providing reliable hurricane protection.", mapUrl: getMapUrl("Manalapan, FL, USA") },
    { name: "Ocean Ridge", address: "Ocean Ridge, FL, USA", description: "Protect your Ocean Ridge home with roofing and impact windows by Roofweiler, your trusted roofing contractors.", mapUrl: getMapUrl("Ocean Ridge, FL, USA") },
    { name: "Palm Beach Shores", address: "Palm Beach Shores, FL, USA", description: "Keep your Palm Beach Shores home hurricane-safe with Roofweiler's expert roofing and impact windows solutions.", mapUrl: getMapUrl("Palm Beach Shores, FL, USA") },
    { name: "Royal Palm Beach", address: "Royal Palm Beach, FL, USA", description: "Secure your Royal Palm Beach home with roofing and impact windows by Roofweiler, the trusted local roofing company.", mapUrl: getMapUrl("Royal Palm Beach, FL, USA") },
    { name: "Tequesta", address: "Tequesta, FL, USA", description: "Roofweiler: Tequesta go-to roofing company for your roofing and energy-efficient impact windows, all with a client-first focus.", mapUrl: getMapUrl("Tequesta, FL, USA") },
    { name: "Westlake", address: "Westlake, FL, USA", description: "Roofweiler: Westlake's trusted roofing and impact windows experts, specializing in roofing and hurricane protection with client-first service.", mapUrl: getMapUrl("Westlake, FL, USA") },
    { name: "Boca Raton", address: "Boca Raton, FL, USA", description: "Roofweiler: Boca Raton's leading roofing and impact windows company with 5-star customer service.", mapUrl: getMapUrl("Boca Raton, FL, USA") },
    { name: "Cloud Lake", address: "Cloud Lake, FL, USA", description: "Roofweiler provides Cloud Lake reliable roofing and impact windows with friendly customer service.", mapUrl: getMapUrl("Cloud Lake, FL, USA") },
    { name: "Golf", address: "Golf, FL, USA", description: "Roofweiler provides Golf reliable roofing and impact windows with friendly customer service.", mapUrl: getMapUrl("Golf, FL, USA") },
    { name: "Haverhill", address: "Haverhill, FL, USA", description: "Haverhill relies on Roofweiler's roofing and impact windows for premium hurricane protection.", mapUrl: getMapUrl("Haverhill, FL, USA") },
    { name: "Juno Beach", address: "Juno Beach, FL, USA", description: "Roofweiler offers Juno Beach reliable roofing and impact windows, ensuring hurricane safety.", mapUrl: getMapUrl("Juno Beach, FL, USA") },
    { name: "Lake Clarke Shores", address: "Lake Clarke Shores, FL, USA", description: "Roofweiler: Lake Clarke Shores' go-to for roofing and impact windows, ensuring reliable hurricane protection.", mapUrl: getMapUrl("Lake Clarke Shores, FL, USA") },
    { name: "Lantana", address: "Lantana, FL, USA", description: "Lantana relies on Roofweiler's roofing and impact windows for exceptional hurricane protection.", mapUrl: getMapUrl("Lantana, FL, USA") },
    { name: "Mangonia Park", address: "Mangonia Park, FL, USA", description: "Upgrade your Mangonia Park home with Roofweiler's roofing and impact windows, ensuring hurricane safety.", mapUrl: getMapUrl("Mangonia Park, FL, USA") },
    { name: "Pahokee", address: "Pahokee, FL, USA", description: "Roofweiler's expert roofing contractors provide Pahokee reliable roofing and impact windows.", mapUrl: getMapUrl("Pahokee, FL, USA") },
    { name: "Palm Springs", address: "Palm Springs, FL, USA", description: "Roofweiler offers Palm Springs roofing and impact windows, ensuring comprehensive hurricane protection with client-first service.", mapUrl: getMapUrl("Palm Springs, FL, USA") },
    { name: "South Bay", address: "South Bay, FL, USA", description: "South Bay residents trust Roofweiler's roofing and impact windows for reliable hurricane protection.", mapUrl: getMapUrl("South Bay, FL, USA") },
    { name: "Wellington", address: "Wellington, FL, USA", description: "Protect your Wellington home with Roofweiler's top-rated roofing and impact windows, ensuring hurricane safety.", mapUrl: getMapUrl("Wellington, FL, USA") },
  ],
};
