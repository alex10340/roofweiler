...
export default function EstimateForm() {
	...
	return (
		<div className="bg-[#1a1a1a] p-8 max-w-md mx-auto lg:mx-0 lg:ml-auto">
			...
			<div className="bg-white p-8">
				<form onSubmit={handleSubmit} className="space-y-6">
					...
					<div>
						...
						>
							<SelectTrigger
								aria-label="Select product of interest"
								className="border-0 border-b-2 border-black rounded-none px-0 focus:ring-0 bg-transparent data-[placeholder]:text-gray-600 text-black"
							>
					...
					<div>
						...
						>
							<SelectTrigger
								aria-label="Select project time frame"
								className="border-0 border-b-2 border-black rounded-none px-0 focus:ring-0 bg-transparent data-[placeholder]:text-gray-600 text-black"
							>
					...
					<div className="flex items-start gap-2 pt-2">
						...
						>
							...
							personalized marketing text messages and emails. To inform me
							about booking my free consultation, remind me of meeting, and
							extend any promotional deal. *
						</label>
					</div>
