...
export default function MetalRoofHero() {
	...
	return (
		<section className="grid md:grid-cols-2 min-h-[516px]">
			...
			<div className="bg-[#1a1a1a] flex items-center justify-center px-6 md:px-12 lg:px-16 py-12 md:py-16">
				<div className="max-w-xl">
					<h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
						Expert Metal Roofing for Miami-Dade, Broward and Palm Beach County
						Homeowners who Deserve Quality.
					</h1>
					<p className="text-[#ffde11] text-base md:text-lg leading-relaxed">
						Wether its a new metal roof, metal re-roofing, or a metal roof
						repair we are here to help you protect your home and make the
						process Stress Free and Worry Free
					</p>
				</div>
			</div>
			...
			<div className="relative min-h-[400px] md:min-h-full">
				<Image
					src="/assets/metal-roof-hero.webp"
					alt="Expert Metal Roofing"
					fill
