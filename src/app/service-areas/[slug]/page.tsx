...
import ServiceAreaPageHero from "@/components/service-area-page-hero";
import { Button } from "@/components/ui/button";
import { Card } from "@/components/ui/card";
import { type ServiceArea, serviceAreasData } from "@/data/service-areas";
				...
				<div className="max-w-4xl mx-auto">
					...
					<div className="space-y-6">
						...
						<p className="text-white leading-relaxed">
							Roofweiler brings top-tier roofing and impact windows to{" "}
							{serviceArea.name} homeowners, focusing on client-first service.
							Our team provides hassle-free roofing repair and replacement while
							ensuring your windows are hurricane-ready. Choose Roofweiler for a
							seamless experience and 5-star-rated service.
						</p>
					</div>
				</div>
			</section>
