		...
		<div className="min-h-screen bg-[#1a1a1a] text-[#ffffff]">
			...
			<section className="px-6 py-12 max-w-4xl mx-auto space-y-16">
				...
				<div className="space-y-6">
					...
					<Link
						href="/financing"
						className="inline-flex items-center gap-2 px-8 py-3 bg-transparent border border-[#ffde11] text-[#ffde11] rounded-md hover:bg-[#ffde11] hover:text-[#1a1a1a] transition-colors w-fit"
					>
