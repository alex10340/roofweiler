				...
				<div className="relative z-10 container mx-auto px-4 h-full flex items-center">
					<div className="flex items-center gap-8 mx-auto max-w-3xl">
						...
						<div className="text-white">
							...
							<Button
								onClick={openModal}
								className="bg-[#1a1a1a] hover:bg-[#000000] text-[#ffe023] border border-[#ffe023] rounded-full px-6"
							>
			...
			>
				...
				<div className="bg-[#1a1a1a] py-8">
					<div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-6">
						...
						<Button
							onClick={openModal}
							className="bg-[#ffe023] hover:bg-[#ffde11] text-[#1a1a1a] font-bold rounded-full px-6"
						>
							REQUEST A FREE ESTIMATE ›
						</Button>
					</div>
